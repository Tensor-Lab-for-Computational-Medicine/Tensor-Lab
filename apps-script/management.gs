...
function _managementDialogHtml() {
  return [
    ...
    '  <button id="ivDraftBtn" class="secondary">Regenerate email draft</button>',
    ...
    '  if(missing){if(force)setStatus($("#ivStatus"),"To generate a draft, "+missing+".","warn");ivRefreshBtn();return}',
    ...
    '      $("#ivBody").value=d.body||"";',
    '      ivDraftDirty=false;btn.textContent="Regenerate email draft";clearStatus($("#ivStatus"));ivRefreshBtn();',
    '    })',
