...
function _managementDialogHtml() {
  return [
    ...
    '  google.script.run.withSuccessHandler(r=>{setStatus(st,"Authorization check complete for "+((r&&r.user)||"this account")+".","ok");$("#setupAuthBtn").disabled=false;loadSetupStatus();})',
